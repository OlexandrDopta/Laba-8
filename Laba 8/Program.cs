...
namespace lab8
{
    class Program
    {
        ...
        {
            string pd = "D:\\OOP_lab8";
            Create(pd);
            Copy(pd + "\\Texts", pd + "\\Dopta");
            Copy(pd + "\\Sources", pd + "\\Dopta");
            Copy(pd + "\\Reports", pd + "\\Dopta");
            Console.WriteLine("Каталоги успiшно скопiйованi");
            Move(pd + "\\Dopta", pd + "\\KN1-B20" + "\\Dopta");
            ...
            void Create(string path)
            {
                ...
                Directory.CreateDirectory(path + "\\KN1-B20" + "\\Dopta");
                Directory.CreateDirectory(path + "\\Dopta");
